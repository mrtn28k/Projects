This is the Tensorflow implementation of Text-to-Image Generation using GAN (TAC-GAN) - by Kamalesh
...
[***requirements.txt***](https://github.com/mrtn28k/Projects/tree/main/Generative%20adversarial%20networks) file.
...
```
git clone https://github.com/mrtn28k/Text-to-Image-Using-GAN.git
cd TAC-GAN
```
